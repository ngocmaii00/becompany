<%-- 
    Document   : profile
    Created on : Feb 17, 2025, 8:35:55 PM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        ...
        <div
            class="flex lg:flex-row flex-col lg:items-start justify-center items-center"
            >
            <div class="flex flex-col items-center">
                <div class="flex flex-col items-center">
                    <img
                        src="images/mai.jpg"
                        alt="avatar"
                        class="rounded-full w-[20em] mx-16 mt-12 mb-8"
                        />
                    <span class="peacesans-font uppercase text-5xl text-center mb-6"
                          >Ngoc Maii</span
                    >
                </div>
                <div class="flex flex-col mx-20 justify-start">
                    <span class="flex flex-row items-center gap-x-4 mb-4">
                        ...
                        <button
                            class="notosans-font font-bold text-center text-xl underline"
                            >
                            Edit profile
                        </button>
                    </span>
            ...
            <form class="mb-16">
                <div
                    class="grid grid-cols-4 mt-16 bg-[#f2e6e6] w-fit mx-10 rounded-lg border-2 border-[#563a2d] notosans-font font-bold px-10 py-8 items-center"
                    >
                    ...
                    <div class="flex flex-col gap-y-2 col-span-2">
                        ...
                        <div class="flex flex-row items-center gap-x-2 py-0.5">
                            ...
                            Male
                            <input
                                class="accent-[#563a2d] md:ms-8 ms-3 size-3"
                                type="checkbox"
                                checked
                                />
                            Female
                        ...
                        <input
                            type="date"
                            class="placeholder-white border-gray-300 text-gray-900 text-sm rounded-md focus:#563a2d focus:border-[#563a2d] block w-full p-2.5 text-opacity-50"
                            />
                    </div>
                    <div
