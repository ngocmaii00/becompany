            ...
            <link rel="stylesheet" href="css/index.css">
                ...
                <body class="bg-white">
                    ...
                    <main class="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 mt-20 lg:mt-16">
                        <div class="relative aspect-square mx-10 md:mx-0 md:ms-10 col-span-1 lg:col-span-2 lg:scale-95 scale-100">
                            <div class="relative mt-10 mb-5">
                                <ul id="slider">
                                    <li class="relative">
                                        <img id="main-img" class="aspect-square h-full w-full object-cover border-[3px] border-gray-900 rounded-[20px]" src="${product.getImages()[0]}" alt="">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div id="description" class="px-10 lg:col-span-3 col-span-1 lg:mt-20 mt-16">
                            <div class="flex flex-row justify-between items-center mb-6">
                                ...
                                <div class="flex flex-row justify-center items-baseline text-nowrap">
                                    ...
                                    <c:if test="${requestScope.rating != -1}">
                                        ...
                                        <p class="ms-1 text-xl font-semibold notosans-font text-lg text-gray-500 "> &nbsp;   ${requestScope.rating}</p>
                                    </c:if>
                                    <c:if test="${requestScope.rating == -1}">
                                        <p class="ms-1 text-xl font-semibold notosans-font text-lg text-gray-500 ">No rating</p>
                                    </c:if>
                                </div>
                            </div>
                            <div class="flex flex-row justify-between text-[#563a2d] bg-[#f2e6e6] py-4 px-4 mb-8">
                                <div class="text-4xl peacesans-font text-nowrap"
                                     id="price">
                                    ${requestScope.price}$</div>
                                <div class="flex flex-row w-3/4 justify-end gap-x-2 items-center"> 
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#543520" class="size-8">
                            ...
                            <div class=" flex flex-row justify-start items-center mb-8">
                                ...
                                <p class="text-[#563a2d] font-semibold text-xl notosans-font inline-block">Color:</p>
                                        ...
                                        <c:if test="${color.value == false}">
                                            <label class="relative h-full w-auto cursor-pointer">
                                                <input
                                                    name="color"
                                                    type="radio"
                                                    class="peer aspect-square size-8 w-auto cursor-pointer appearance-none rounded-full border-[3px] border bg-[${color.key}] border-[#543520] checked:border-[${color.key}] text-[${color.key}] checked:ring-[#000000] focus:ring-[${color.key}] transition-all" 
                                                    value="${color.key}"
                                                    checked
                                                    onclick="showSize()"

                                                    />
                                                <span class="absolute aspect-square size-4 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 top-75/100 left-7/10 transform -translate-x-1/2 -translate-y-1/2">
                            ...
                            <div class="flex flex-row items-center mb-8">
                                <p class="text-[#563a2d] font-semibold text-xl notosans-font inline-block">Size:</p>
                                            ...
                                            <c:forEach items="${type.value}" var="value" varStatus="stat">
                                                <li class="inline mr-1">
                                                    ...
                                                    <label for="size-${typeIndex.index}-${value}"
                                                        ...
                                                        <div class="block">
                                                            <div class="w-full text-md notosans-font font-semibold">${value}</div>                                       
                                                        </div>      
                                                    </label>
                                                </li>
                                            </c:forEach>
                            ...
                            <div class="flex flex-row items-center mb-8">
                                <p class="text-[#563a2d] font-semibold text-xl notosans-font inline-block">Quantity: </p>

                                <div class="flex flex-row ms-8 px-1 py-0.5 gap-x-4 justify-between items-center border border-[3px] border-[#563a2d] rounded-lg w-28">
                                    <button id="plus" onclick="plus()" class="col-span-1 bg-[#563a2d] size-6 place-items-center text-white rounded-md cursor-pointer hover:bg-[#563a2d]/70">
                                    ...
                                    <p id="quantity-num" name="quantity" class="font-semibold text-xl text-[#563a2d]">1</p>

                                    <button id="minus" onclick="minus()" class="col-span-1 bg-[#563a2d] size-6 place-items-center text-white rounded-md cursor-pointer hover:bg-[#563a2d]/70">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="size-4">
