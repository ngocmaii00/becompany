<%-- Document : product.jsp Created on : Feb 18, 2025, 7:49:19 PM Author : zeryus --%>
                                ...
                                <%@include file="header.jsp" %>
                                    ...
                                    <main class="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 mt-20 lg:mt-16">
                                                ...
                                                <c:forEach items="${product.getImages()}" var="img" varStatus="status">
                                                    <label class="inline-block aspect-23/18 mr-2 h-full w-auto">
                                                        <input onclick="selectImg(this)" type="radio"
                                                            id="img-${status.index + 1}" name="img" value=""
                                                        ...
                                                        <div for="img-${status.index + 1}"
                                                            ...
                                                            <img class="h-full w-full object-cover rounded-[17px]"
                                                                src="${img}" alt="">
                                                        </div>
                                                    </label>
                                                </c:forEach>
                                        ...
                                        <div id="description" class="px-10 lg:col-span-3 col-span-1 lg:mt-20 mt-16">
                                            ...
                                            <div class=" flex flex-row justify-start items-center mb-8">
                                                ...
                                                <p
                                                    class="text-[#563a2d] font-semibold text-xl notosans-font inline-block">
                                                    Color:</p>
                                                            ...
                                                            <label class="relative h-full w-auto cursor-pointer">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="text-[#ffffff]" fill="none"
                                                                        viewBox="0 0 24 24" stroke-width="7"
                                            ...
                                            <div class="flex flex-row items-center mb-8">
                                                ...
                                                <div class="w-78/100 ml-10 inline-block">
                                                    <c:forEach items="${requestScope.type}" var="type"
                                                        varStatus="typeIndex">
                                                        <ul class="flex flex-row gap-4 w-full" id="${type.key}"
                                                            name="size" style="display:none;">
                                                            <c:forEach items="${type.value}" var="value"
                                                                varStatus="stat">
                                                                <li class="inline mr-1">
                                                                    <input type="radio" onclick="submitForm()"
                                                                        id="size-${typeIndex.index}-${value}"
                                                                        name="size" value="${value}" class="hidden peer"
                                                                        ${stat.first?"checked":""} />
                                    ...
                                    <%@include file="footer.jsp" %>
                                        ...
                                        <form id="cartForm" action="cart" method="post">
                                            ...
                                            <input type="hidden" id="instockInput" name="instock"
                                                value="${requestScope.instock}">
                                        </form>
                                        <script>
                                            function submitCart() {
                                                updateForm();
