        ...
        <div class="py-5em flex flex-row gap-6 justify-center" style="background-color: #4f362b; height:90%; width:100%; ">
            ...
            <div class="basis-1/2 font-medium font-bold">
                ...
                <div class=" flex flex-col gap-8  h-[83%] w-[75%]  p-[7%] pt-[4%] px-1/5 bg-[#f2e6e6] rounded-3xl border-3 border-gray-950" style="margin:6% 14% 6% 7%;">
                    <h1 class="basicuppercase font-bold text-6xl text-center " style="color:#563a2d">
                        Login
                    </h1>
                <form class="h-[50%]"action="login" method="post">
                    <div class=" mb-3 h-[4em] w-10/10">
                        <input type="text" name="username" id="username" class="h-full w-full text-2xl border-4 border-gray-950 rounded-3xl h-full p-1 bg-grey-50 pl-[16px] placeholder:font-bold" style="background-color:#ffffff" placeholder="Username">
                    </div>
                    <div class="mb-3  h-[4em] w-10/10 relative">
                        <input type="password" name="password" id="password" class="h-full w-full text-2xl border-4 border-gray-950 rounded-3xl p-1 h-full bg-grey-50 pl-[16px] placeholder:font-bold" style="background-color:#ffffff" placeholder="Password">
                    ...
                    <div class="grid grid-cols-2 mb-2 mx-2">
                        <div class=" flex flex-row">
                            ...
                            <label class="text-xl ml-1 font-bold text-[#563a2d]"for="remember"> Remember me</label>
                        </div>
                    ...
                    <div class="h-[4em] w-full mt-4">
                        <button type="submit" class="h-full text-4xl text-white w-full h-full py-2/10 font-bold uppercase"style="background-color: #563a2d;">Login</button>    
                    </div>
                ...
                <div class="  text-xl text-center ">
                    ...
                    <button type="button" class="inline-block ml-1 px-2.5 py-0.5 font-large text-gray-50 rounded-3xl" style="background-color: #563a2d;">Sign up</button>
                </div>
            </div>
        </div>
    </div>
