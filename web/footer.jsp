<%-- 
    Document   : footer
    Created on : Feb 20, 2025, 6:51:00 PM
    Author     : PC
--%>
                    ...
                    <div class="grid grid-cols-2 gap-8 place-items-center">
                        ...
                        <div>
                            ...
                            <ul class="text-[#543520] font-medium">
                                ...
                                <li>
                                    <a href="#" class="hover:underline">Hotline Feedback</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                </div>
                <hr class="my-6 border-[#543520] sm:mx-auto lg:my-8">
                <div class="flex items-center justify-between">
                    <span class="text-sm text-[#543520] sm:text-center">© 2025 <a href="###" class="hover:underline">Becompany.</a>
                    </span>
                    <div class="flex mt-4 sm:justify-center sm:mt-0 text-[#543520]">
                        <a href="#" class="hover:opacity-100 opacity-70">
                        ...
                        <a href="#" class="hover:opacity-100 opacity-70 ms-5">
