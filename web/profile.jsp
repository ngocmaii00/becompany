    ...
    <body>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col items-center">
                    <div style="background-image: url('${user.image}');"
                        class="avatar bg-cover bg-center size-[18em] rounded-full mb-8 shadow-lg border-2 border-[#563a2d]"></div>
            ...
            <div class="mb-16"  action="ProfileServlet" method="POST">
                ...
                <div class="grid grid-cols-4 bg-[#f2e6e6] w-fit mx-10 rounded-lg border-2 border-[#563a2d] notosans-font font-bold px-10 py-8 items-center">
                    <div class="flex flex-col col-span-2 sm:col-span-1">
                        ...
                        <label for="re-enter-password" class="confirmPassword py-3.5" hidden>Confirm Password:</label>
                    ...
                    <div class="flex flex-col gap-y-2 col-span-2">
                            <input class="py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                                   name="username"
                                   id="username"
                                   value="${user.username}"
                                   disabled>
                        ...
                        <div class="max-w-sm">
                            <div class="relative">
                                ...
                                <button type="button" 
                                        data-hs-toggle-password="{#hs-toggle-password&quot;
                            ...
                            <div class="confirmPassword relative" hidden>
                                <input id="hs-toggle-confirm-password" 
                        ...
                        <input class="py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                               ...
                               disabled>
                        <input class="firstName py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                               name="firstName"
                               id="firstName"
                               value="${details.firstName}"
                               style="display: none">   
                        <input class="lastName py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                               name="lastName"
                               id="lastName"
                        ...
                        <input class="py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                               name="phone"
                                 id="phone"
                               value="${details.phone==null?'':details.phone}"
                               disabled>    
                        <div class="flex flex-row items-center gap-x-2 py-1">
                            <input class="accent-[#563a2d] size-3" name="gender" value="true"  type="radio" disabled ${details.gender?"checked":"" }>
                            Male
                            <input class="accent-[#563a2d] md:ms-8 ms-3 size-3" name="gender" value="false" type="radio" disabled ${details.gender?"":"checked"}>
                            Female
                        </div>
                        <input class="py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-white  disabled:pointer-events-none" 
                            name="address"
                    ...
                    <div class="flex flex-col justify-center items-center gap-y-4 sm:ms-8 mt-10 sm:mt-0 col-span-4 sm:col-span-1">
                        <div style="background-image: url('${user.image}');"
                             class="avatar ms-2 bg-cover bg-center md:size-[6em] size-[8em] rounded-full border-2 border-[#543520] shadow-lg"></div>
                ...
                <div class="flex flex-row justify-between mx-10 mt-4">
                    <a href="home" class="flex flex-row bg-[#563a2d] w-fit rounded-lg justify-center items-center px-4 py-3 gap-x-2">
                    ...
                    <button onclick="submitForm()" id="save_profile" class="flex flex-row bg-[#563a2d] w-fit rounded-lg justify-center items-center px-6 py-3 gap-x-2 font-bold text-white text-lg" disabled>
                        Save Profile
                    </button>
                </div>
            </div>
        ...
        <script>
            function toggleEdit(){
                ...
                let allConfirmPassword = document.querySelectorAll(".confirmPassword, .firstName, .lastName");
                ...
                //     reader.readAsDataURL(file); // Read the file as a data URL
                    ...
                    fetch("profile_avatar",
                        ...
                        .then(data => {
                            ...
                            if(data.success){
                                for(let i = 0; i < img.length; i++)
                            img[i].style.backgroundImage = `url('${data.success}')`
                            }
                        })
                        .catch(error => {
        ...
        <script>
            function submitForm() {
                ...
                let confirmPassword = document.querySelector("input[name='re-enter-password']").value;
