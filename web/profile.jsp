            ...
            <div class="flex flex-col items-center">
                <div class="flex flex-col items-center">
                    ...
                    <c:forEach items="${requestScope.data}" var="a">
                        <span class="peacesans-font uppercase text-5xl text-center mb-6">${a.getUsername()}</span>
                    </c:forEach>
                ...
                <div class="grid grid-cols-4 bg-[#f2e6e6] w-fit mx-10 rounded-lg border-2 border-[#563a2d] notosans-font font-bold px-10 py-8 items-center">
                    <c:forEach items="${requestScope.data}" var="a">
                        <div>
                            ...
                            <span class="bg-white focus:border-2 focus:border-[#563a2d] rounded-md text-[#563a2d] px-3 py-2.5 font-semibold text-md">${a.getUserId()}</span>
                        </div>
                        <div>
                            <label for="username">Username: </label>
                            <span class="bg-white focus:border-2 focus:border-[#563a2d] rounded-md text-[#563a2d] px-3 py-2.5 font-semibold text-md">${a.getUsername()}</span>
                        </div>
                        <div>
