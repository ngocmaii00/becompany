...
public class UserDAO extends DBConnect {
    ...
    public List<Customer> getAll() {
        String sql = "select u.userId, u.username, u.email, u.role, u.status, b.price, b.quantity, ud.firstName, ud.lastname, ud.gender, ud.address, ud.dob "
    ...
    public static void main(String[] args) {
        ...
        List<Customer> users = ud.filterCustomer(10, 2, "notbuyyet");
        System.out.println(users.get(0).getUserDetail().getNumberOfOrder());
    }
}
